...
$.widget("ui.selectmenu", {
	...
	_create: function() {
		...
		this.newelement = $('<a class="' + this.widgetBaseClass + ' ui-widget ui-state-default ui-corner-all" id="' + this.ids[0] + '" role="button" title="You Can click here to change services." href="#" tabindex="0" aria-haspopup="true" aria-owns="' + this.ids[1] + '"></a>')
